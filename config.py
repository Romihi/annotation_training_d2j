...
GRU_DEFAULT_STRIDE = TRAJ_DEFAULT_STRIDE
GRU_DEFAULT_GRU_HIDDEN = TRAJ_DEFAULT_HIDDEN_DIM
GRU_DEFAULT_GRU_LAYERS = TRAJ_GRU_DEFAULT_NUM_LAYERS
GRU_DEFAULT_DROPOUT = TRAJ_DEFAULT_DROPOUT
GRU_DEFAULT_IMG_SIZE = TRAJ_DEFAULT_IMG_SIZE
GRU_DEFAULT_EPOCHS = TRAJ_DEFAULT_EPOCHS
GRU_DEFAULT_BATCH_SIZE = TRAJ_DEFAULT_BATCH_SIZE
