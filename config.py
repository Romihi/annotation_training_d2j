...
# 時系列モデル学習パラメータ（共通）
SEQ_DEFAULT_SEQ_LEN = 8
SEQ_DEFAULT_PRED_HORIZON = 10
SEQ_DEFAULT_STRIDE = 1
SEQ_DEFAULT_HIDDEN_DIM = 256
SEQ_DEFAULT_DROPOUT = 0.1
SEQ_DEFAULT_IMG_SIZE = (128, 128)
SEQ_DEFAULT_EPOCHS = 30
SEQ_DEFAULT_BATCH_SIZE = 16
...
GRU_DEFAULT_PRED_HORIZON = SEQ_DEFAULT_PRED_HORIZON
GRU_DEFAULT_STRIDE = SEQ_DEFAULT_STRIDE
GRU_DEFAULT_GRU_HIDDEN = SEQ_DEFAULT_HIDDEN_DIM
GRU_DEFAULT_GRU_LAYERS = SEQ_GRU_DEFAULT_NUM_LAYERS
GRU_DEFAULT_DROPOUT = SEQ_DEFAULT_DROPOUT
GRU_DEFAULT_IMG_SIZE = SEQ_DEFAULT_IMG_SIZE
GRU_DEFAULT_EPOCHS = SEQ_DEFAULT_EPOCHS
GRU_DEFAULT_BATCH_SIZE = SEQ_DEFAULT_BATCH_SIZE
