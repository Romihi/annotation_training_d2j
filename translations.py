...
================================================================================''',
        ...
        'label_model_arch': 'モデルアーキテクチャ',
        'label_arch_params': 'アーキテクチャ パラメータ',
...
================================================================================''',
        ...
        # Time-Series Trajectory Model
        'btn_traj_train': 'Train',
        'dlg_traj_training_settings': 'Time-Series Trajectory Model - Training Settings',
        ...
        'label_model_arch': 'Model Architecture',
        'label_arch_params': 'Architecture Parameters',
        ...
        'msg_traj_training': 'Training time-series trajectory model...',
        'dlg_traj_model_training': 'Time-Series Trajectory Model Training',
        'msg_traj_training_complete': 'Time-series trajectory model training completed',
        ...
        'dlg_traj_predict_settings': 'Time-Series Trajectory - Inference Settings',
        'dlg_traj_prediction': 'Time-Series Trajectory Prediction',
        'msg_traj_predicting': 'Running time-series trajectory inference...',
        'msg_traj_prediction_complete': 'Time-series trajectory inference completed',
        'msg_traj_prediction_count': 'Generated predictions for {0} frames',
        'msg_no_traj_models': 'No trajectory models found. Please run trajectory training first.',
        'label_select_traj_model': 'Select Trajectory Model',
        'label_traj_model_info': '{0} | seq={1}, horizon={2}, sources={3}',
        'chk_show_traj_prediction': 'Show Predicted Trajectory',
        'label_traj_pred_steering': 'Pred (steering)',
        'label_traj_pred_throttle': 'Pred (throttle)',
        'label_traj_inference_result': 'Trajectory Inference:',
        'label_traj_section_title': 'Time-Series Trajectory Model',
        'label_all': 'All',
        ...
        'dlg_gru_training_settings': 'Time-Series Trajectory Model - Training Settings',
        'label_gru_params': 'Architecture Parameters',
        'label_gru_hidden': 'Hidden Size',
        'msg_gru_training': 'Training time-series trajectory model...',
        'dlg_gru_model_training': 'Time-Series Trajectory Model Training',
        'msg_gru_training_complete': 'Time-series trajectory model training completed',
        ...
        'dlg_gru_predict_settings': 'Time-Series Trajectory - Inference Settings',
        'dlg_gru_prediction': 'Time-Series Trajectory Prediction',
        'msg_gru_predicting': 'Running time-series trajectory inference...',
        'msg_gru_prediction_complete': 'Time-series trajectory inference completed',
        'msg_gru_prediction_count': 'Generated predictions for {0} frames',
        'msg_no_gru_models': 'No trajectory models found. Please run trajectory training first.',
        'label_select_gru_model': 'Select Trajectory Model',
        'label_gru_model_info': 'seq_len={0}, pred_horizon={1}, sources={2}',
        'chk_show_gru_prediction': 'Show Predicted Trajectory',
        'label_gru_pred_steering': 'Pred (steering)',
        'label_gru_pred_throttle': 'Pred (throttle)',
        'label_gru_section_title': 'Time-Series Trajectory Model',
    },
}
