...
TRANSLATIONS = {
    ...
    'ja': {
        ...
        'chk_show_auto_driving_direction': '走行軌跡を表示',
        ...
        'tip_auto_driving_direction': 'アノテーション点のangle値から走行軌跡を円弧で表示',
        'tip_auto_max_steering': '走行軌跡表示に使用する最大舵角（度）',
...
================================================================================''',
    ...
    'en': {
        ...
        'chk_show_auto_driving_direction': 'Show Driving Trajectory',
        ...
        'tip_auto_driving_direction': 'Display driving trajectory arc from annotation angle value',
        'tip_auto_max_steering': 'Maximum steering angle used for trajectory display (degrees)',
