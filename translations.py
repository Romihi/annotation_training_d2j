...
TRANSLATIONS = {
    ...
    'ja': {
        ...
        'tip_recorded_traj_points': '走行軌道の表示点数（1点=0.05秒先。空欄でデフォルト20点=1秒先）',
...
================================================================================''',
    ...
    'en': {
        ...
        'placeholder_recorded_traj_points': '20',
        'tip_recorded_traj_points': 'Number of driven-trajectory points to display (1 pt = 0.05 s ahead; empty = default 20 pts = 1 s)',
